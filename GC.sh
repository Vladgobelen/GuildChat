...
cat /home/diver/Скрипты/mods/tesseract/rus.traineddata.txt |grep -i ВОЖДЬ | awk '{print $2}' |tr -d \[]: |awk -v RS="\0" '{print $NF}' > /home/diver/Скрипты/temp/GC/res;
...
xclip -sel clip -o >/home/diver/Скрипты/temp/GC/xres
j=$(cat /home/diver/Скрипты/temp/GC/xres);
kdialog --msgbox "$j";
